...
%      \CVItemListEnd
    ...
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{Developed a linear forward model in C++ to characterize the imaging system response.}
        \CVItem{Implemented an accelerated Monte Carlo algorithm in C++ to perform scattering correction.}
