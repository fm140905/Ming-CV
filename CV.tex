...
%      \CVItemListEnd
   \CVSubheading
      {\shortstack[l]{EINSTEIN: Enhanced Integrated Nuclear Systems for Transmutation and \\Efficient Isolation of Nuclides}}{Sept 2025 - Present}
      {Research Scientist, Supervisor: Prof. Angela Di Fulvio, UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Performed sensitivity/uncertainty analysis of accelerator-driven systems for spent fuel transmutation and identified critical gaps in existing nuclear data for accurate simulation.}
      \CVItemListEnd
  \CVSubheading
      {\shortstack[l]{Non-Destructive Plutonium Assay in Pyroprocessing Bulk Materials with a \\3D Boron-Coated-Straw Detector Array}}{Aug 2024 - Present}
      {Research Scientist, Supervisor: Prof. Angela Di Fulvio, UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Developed and characterized a set of boron-coated straw-based detector panels for neutron assay of bulk materials.}
      \CVItemListEnd
    \CVSubheading
      {\shortstack[l]{Optimization of Fueling Strategies and Material Surveillancethrough  Real-time \\Pebble Tracking in Pebble Bed Reactors}}{Aug 2024 - Present}
      {Research Scientist, Supervisor: Prof. Angela Di Fulvio, UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Developed and characterized a set of boron-coated straw-based detector panels for neutron assay of TRISO-fueled pebbles.}
      \CVItemListEnd
    \CVSubheading
...
\begin{enumerate}
% \setcounter{enumi}{0}
    \item \bibentry{MingPGETNSSMIC2025}
    \item \bibentry{ADFDOINSSMIC2025}
    \item \bibentry{Lacy2025}
    \item \bibentry{leland2025feasibility}
    \item \bibentry{MingEINSTEINSPIE2025}
...
\section{Professional Service Aativities}
\CVSubHeadingListStart
    \CVSubheading
    {Reviewer of Peer-Reviewed Journals}{ }
    { }{}\vspace{-1em}
    \CVItemListStart
      \CVItem{IEEE Transactions on Nuclear Science}
      \CVItem{Nuclear Inst. and Methods in Physics Research, A}
      \CVItem{Annals of Nuclear Energy}
      \CVItem{Nuclear Engineering and Technology}
      \CVItem{Radiation Measurements}
      \CVItem{Journal of Nuclear Materials Management}
      \CVItem{Applied Radiation and Isotopes}
      \CVItem{Journal of Radioanalytical and Nuclear Chemistry}
      \CVItem{Nuclear Science and Engineering}
      \CVItem{Nuclear Engineering and Design}
    \CVItemListEnd
    \CVSubheading
      {Session Chair}{}
      {}{}\vspace{-1em}
      \CVItemListStart
        \CVItem{``Advanced Imaging and Autonomous Systems for Environmental Monitoring and Nonproliferation'', 2025 IEEE NSS-MIC-RTSD}
      \CVItemListEnd
  \CVSubHeadingListEnd
