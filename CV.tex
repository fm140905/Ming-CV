...
\begin{center}
    ...
    {1615 Melrose Park Ct, Apt 2022, Urbana, IL 61801, USA}
    % {US ADD: 1615 Melrose Park Ct, Apt 2022, Urbana, IL 61801, USA}\\
...
%      \CVItemListEnd
    \CVSubheading
      ...
      {UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Designed a neutron multiplicity counter to perform non-destruction assay of fuel pebbles.}
        \CVItem{Implemented an accelerated Monte-Carlo algorithm to simulate X-ray images of a pebble generated by an industrial CT scanner.}
        \CVItem{Developed image reconstruction, image segmentation, and fuel pebble identification algorithms.}
    ...
    %   \CVItemListEnd
    \CVSubheading
      {Quantitative Image Reconstruction in Passive Gamma Emission Tomography}{Aug 2019 -- Sept 2020}
      {UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Developed a linear forward model to characterize the imaging system response.}
        \CVItem{Implemented an accelerated Monte Carlo algorithm to perform scattering correction.}
        \CVItem{Developed a full set of software to reconstruct cross-sectional images of inspected fuel assemblies, identify missing fuel pins, and estimate fuel pin activities.}
      \CVItemListEnd
    \CVSubheading
      {Active Interrogation Using a DD Neutron Generator}{May 2019 -- May 2020}
      {UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Implemented a shift-register algorithm to calculate the coincidence neutron count rate.}
    ...
    %   \CVItemListStart
    %     \CVItem{Learnt about the various facets of the science of exotic nuclei including nuclear structure, fundamental interactions, and the application of nuclear science and technology.}
    %   \CVItemListEnd
    \CVSubheading
      ...
      \CVItemListStart
        ...
        \CVItem{Implemented an interpolation-based constant-fraction discrimination (CFD) timing algorithm to determine the pulse arrival time.}
      \CVItemListEnd
    \CVSubheading
      {General-Purpose Pulse-Processing Program}{Sept 2018 – Present}
      {UIUC}{Urbana, USA}
      \CVItemListStart
        \CVItem{Developed a fast and general-purpose pulse-processing program based on the CERN ROOT framework.}
      \CVItemListEnd
    \CVSubheading
      {Implementation of Key Algorithms in Gamma Spectrum Analysis Software}{Jul 2017 – Mar 2018}
      {USTC}{Hefei, China}
      \CVItemListStart
...
% \setcounter{enumi}{0}
    ...
    \item \bibentry{MingTRISOANS2021}
...
% \begin{itemize}[leftmargin=0.5cm, label={}]
%     \small{\item{
%     %  Fellow of Exotic Beam Summer School \hfill Jun 2019 \\
%     %   {Oak Ridge National Laboratory} \hfill { } \\
