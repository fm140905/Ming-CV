     ...
     {University of Illinois Urbana-Champaign}{Urbana, IL, USA}
      \CVItemListStart
        ...
        \begin{enumerate}[leftmargin=0.5cm, nolistsep]
            \item \begin{tabular*}{0.90\textwidth}[t]{l@{\extracolsep{\fill}}r}{Multi-Mode Imaging for TRi-structual ISOtropic (TRISO) Fuel Pebble Identification} & \small{Aug. 2020 -- Present}\end{tabular*}
            \begin{enumerate}[leftmargin=1.0cm, nolistsep, label=(\roman*)]
            \item Designed a boron-coated straw-based neutron multiplicity counter to perform non-destruction assay of TRISO-fueled pebbles.
            \item Developed a fuel pebble identification algorithm based on X-ray Computed Tomography scans of TRISO-fueled pebble.
            \end{enumerate}
            ...
            \begin{enumerate}[leftmargin=1.0cm, nolistsep, label=(\roman*)]
            \item {Developed and optimized a PALS experimental setup using organic scintillators and fast digitizers.}
            \item {Measured the positron lifetime in quartz samples.}
            \end{enumerate}
        \end{enumerate}
      \CVItemListEnd
...
%      {Institution of Study}{Where it is located}
    \CVSubheading
      ...
      \CVItemListStart
        ...
        \end{enumerate}
        \CVItem{\textbf{Honors or awards:} J.D. Williams Student Paper Award for presentation at the Institute of Nuclear Materials Management 63\textsuperscript{rd} Annual Meeting in July 2022.}
      \CVItemListEnd
    \CVSubheading
